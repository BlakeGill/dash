...
from influx_client import InfluxCoreClient
...
if __name__ == '__main__':
    ...
    upload()
    #upload_VISA_directory()
    print("Upload Test: Waiting 5 seconds for all batch processes on server side to complete.", file=sys.stderr)
    time.sleep(5)
